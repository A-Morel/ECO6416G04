...
```
<br>
After analyzing our performance measures for the 3 models we have noticed that our bad model has a high RMSE, which does not surprise us. For the short-run, the best model would definitely be Model 2 (lnChargeslnAgeSqBMI) with the lowest RMSE, even though Model 1(lnChargeslnAgelnBMI) has the lowest BIAS.
<br>
...
```
We notice how all the customers fall withing the ranges of each independent variables.