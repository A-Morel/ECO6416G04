...
<br>
WinterSprings with a 0.110613 <br>
Smoker with 6.59e-12<br>
BMI with 2.96e-07 <br>
Age with 0.000746 <br>
...
Age: For every year there is $236 added to the charges
BMI: For every point increment in the BMI our charges go up in 803
Smoker: If the person is smoker it adds..
WinterSprings: if the person lives in winter springs rather than sanford the charges go up by 1962.97
...
Comparing both models without the city variables showed no significant reduction SEE so there is no significant difference between one model that includes dummy variables and the second model that does not. 
